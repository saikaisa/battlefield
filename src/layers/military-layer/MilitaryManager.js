...
export class MilitaryManager {
  ...
  async init() {
    ...
    const renderingAttributes = {
      ...
      model_path: "/assets/model_final.glb",
      // 定义 LOD 方案：距离越远加载越低细节的模型
      lod_levels: [
        { level: 0, distance: 0, model_path: "/assets/model_final.glb" },
        { level: 1, distance: 800, model_path: "/assets/model_final.glb" },
        { level: 2, distance: 1500, model_path: "/assets/model_final.glb" }
      ]
    };
